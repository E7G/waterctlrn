...
const errorCases: ErrorCase[] = [
  {
    ...
    links: [{ url: 'https://github.com/E7G/waterctlrn', text: '反馈给开发者' }],
    isFatal: false,
    showLogs: true,
  },
  {
  ...
  },
  {
    ...
    links: [{ url: 'https://github.com/E7G/waterctlrn', text: '源代码仓库' }],
    isFatal: true,
    showLogs: false,
  },
  {
    ...
    links: [
      { url: 'https://github.com/E7G/waterctlrn/blob/main/FAQ.md', text: '“疑难解答”' },
      { url: 'https://github.com/E7G/waterctlrn', text: '源代码仓库' }
    ],
    isFatal: true,
    showLogs: false,
  },
